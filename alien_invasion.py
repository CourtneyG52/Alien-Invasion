...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            #Create a new fleet andcenter the ship
            self._create_fleet()
    ...
    def _create_fleet(self):
        ...
        #Determine the number of rows aliens fit on screen
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if collisions:
            for aliens in collision.values():
                self.stats.score += self.settings.alien_points * lens(aliens)
            self.sb.prep_score()
    ...
    def _check_fleet_edges(self):
        #Responds appropirately if any aliens have reached the edge
    ...
    def _update_screen(self):
        ...
        #Draw play button id game is not active
